...
class ZBonService:
    ...
    def _render_current_zbon_html(self, payload: dict) -> str:
        ...
        return template.render(
            ...
            cash_sales_net=f"{summary.get('article_cash_sales_total', 0):.2f}",
            cash_sales_tax="0.00",
            cash_sales_gross=f"{summary.get('article_cash_sales_total', 0):.2f}",
            ...
            total_items_count=summary.get("sales_count", 0) + summary.get("recharge_count", 0),
