...
export const useAppSettingsStore = defineStore('app-settings', () => {
  ...
  const applyToDocument = () => {
    ...
    const opacity = settings.value.kasse_products_background_opacity ?? 100
    document.documentElement.style.setProperty('--kasse-products-background-opacity', `${opacity}%`)
