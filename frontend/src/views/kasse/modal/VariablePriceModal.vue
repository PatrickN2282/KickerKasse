    ...
    <div class="modal-dialog">
      <div class="modal-header">
        <div>
          ...
          <p class="subtitle">{{ pendingVariablePriceProduct.name }}</p>
        </div>
        <button class="close-btn" @click="closeVariablePriceModal">✕</button>
      </div>
      ...
      <div class="modal-footer">
        <button @click="closeVariablePriceModal" class="btn btn-secondary">Abbrechen / Zurück</button>
        <button
